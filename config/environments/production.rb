...
Rails.application.configure do
  ...
  config.action_mailer.default_options = {
    from: "noreply@toy-app-4-yajg.onrender.com"  # email đã verify trên SendGrid
  }

  config.action_mailer.smtp_settings = {
    address:              "smtp.sendgrid.net",
    port:                 587,
    domain:               "toy-app-4-yajg.onrender.com",
    user_name:            "apikey",               # bắt buộc dùng 'apikey'
    password:             ENV["SENDGRID_API_KEY"], # set trên Render Environment
    authentication:       :plain,
    enable_starttls_auto: true
  }
